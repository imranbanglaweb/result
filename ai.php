...
<div class="row">
  ...
  <div class="fulimg">
     ...
     while($row = mysqli_fetch_row($resultimg)) {?>
       <table>
         <tr>
           <td><?php echo "<img class='img-responsive' src='uploads/$row[14].jpg' height='100px' width='250px'>";?></td>
         </tr>
       </table>
     <?php }?>
...
<div class="subject">
  <ul>
    <li>
      <a href="ai.php">
        <span class="subject">
        <h2>Details Of Artificial & Intelligence</h2>
        </span>
      </a>
      <h3><a href="">Subject Code:CSE-407</a></h3>
...
<h3>
  <h2>View Others Subject Details</h2>
    <ul>
      ...
      <li><a href="parallel.php">Parallel & Distributing</a></li>
    </ul>
</h3>
</div>
<br>
